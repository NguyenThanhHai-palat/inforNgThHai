...
function load_content(data){
  ...
  if(data=="https://palat.io.vn/?about") { document.getElementById("content").innerHTML = '<nav class="navbar navbar-expand-lg bg-dark" data-bs-theme="dark"> <div class="container-fluid"> <a class="navbar-brand"></a> <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarColor02" aria-controls="navbarColor02" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span> </button> <div class="collapse navbar-collapse" id="navbarColor02"> <ul class="navbar-nav me-auto" id="nav_controller"> <li class="nav-item"> <a class="nav-link" href="/">Trang Chủ </a> </li> <li class="nav-item"> <a class="nav-link" href="?thongtinkhac">Thông Tin Khác</a> </li> <li class="nav-item"> <a class="nav-link active" href="?about">Về tôi</a> </li> </ul> </div> </div> </nav> <div id="a"> <div class="container" data-aos="zoom-in" data-aos-delay="100"> <br> <br> <div class="col-lg-8 pt-4 pt-lg-0 container"> <div class="row"> <div class="col-lg-6"> <ul> <li><i class="bi bi-chevron-right"></i> <strong>SĐT-Cv:</strong> <span>0853216297</span></li> <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong> <span>https://palat.io.vn</span></li> <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span><a href="https://mail.google.com/mail/u/0/?fs=1&to=me@palat.io.vn&su=G%E1%BB%ADi%20email&body=&tf=cm">me@palat.io.vn</a></span></li> <li><i class="bi bi-chevron-right"></i> <strong>Nơi ở:</strong> <span>Phường Trấn Biên, Tp.Đồng Nai, Việt Nam</span></li> </ul> </div> <div class="col-lg-6"> <ul> <li><i class="bi bi-chevron-right"></i> <strong>MỤC TIÊU:</strong> <span>TRƯỜNG ĐẠI HỌC CÔNG NGHỆ KỸ THUẬT TPHCM</span></li> <li><i class="bi bi-chevron-right"></i> <strong>Tuổi:</strong> <span>18<</span></li> <li><i class="bi bi-chevron-right"></i> <strong>Hiện là:</strong> <span>Học sinh</span></li> </ul> </div> </div> </div> </div> </div><div hidden><hr><h2>Vlog</h2><p>Ẩn ròi :)</p></div>'}
